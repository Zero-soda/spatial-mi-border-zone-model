...
This study re-analysed publicly available spatial transcriptomic data from GEO accession GSE214611 [16]. The mouse MI Visium samples analysed here correspond to GSM6613084, GSM6613085, GSM6613086, GSM6613087, GSM6613088 and GSM6613089, and the human STEMI Visium transfer analysis used GSM6613090. No new primary human, animal or clinical data were generated in this study. Source data underlying the main and extended-data figures are provided in `submission/source_data`, and processed supplementary tables are provided in `submission/supplementary_tables`. A repository-ready code and processed-data release skeleton is provided in `submission/repository_release`; the final public GitHub URL and Zenodo DOI will be inserted before formal journal upload.

## Code Availability

Analysis scripts are stored locally under `analysis/spatial_cardiac_border_zone/scripts` and are listed in `submission/code_reproducibility_readme.md`. The scripts, processed source-data tables, supplementary tables and figure-generation workflow are prepared for deposition in a public GitHub repository and archival Zenodo release. The final repository URL and Zenodo DOI will be inserted into this section before formal journal upload.
